...
# changed 1/31/2023 train_df = pd.read_csv("../dat/train.csv.gz", compression="gzip")
...
with st.sidebar:
    ...
    # YOUR CODE GOES HERE!
    models = ["linear_model", "dnn_model","ExtraTree"]
...
with tab2:    
    ...
    cm1  = model1_results[cols].to_numpy()[0].tolist()
    z1 = cm1
    ...
    with col2:
        ...
        cm2  = model2_results[cols].to_numpy()[0].tolist()
