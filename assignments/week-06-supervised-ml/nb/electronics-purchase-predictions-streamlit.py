...
train_df = pd.read_csv("assignments/week-06-supervised-ml/nb/train.csv.gz", compression="gzip")
model_results_df = pd.read_csv("assignments/week-06-supervised-ml/nb/model_results.csv")
